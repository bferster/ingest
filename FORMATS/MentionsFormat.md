...
**Field names and descriptions:**
	...
	- The following columns represent information about the person in a row {
		...
		- data - any extra information about the person that is not included in the other fields or normalized fields
		- verid - The Verité ID of the person if it is known.
		}

**Example rows**

| mention_id   | source | source_year | confidence | full_name       | first_name | middle_name | last_name | birth_year | birth_place | death_year | race | gender | occupation | legal_status | norm_first_name | nysiis_last_name | norm_race | norm_occupation | head | household_id | family_id | metaphone_last_name | verid | data
|--------------|--------|-------------|------------|-----------------|------------|-------------|-----------|------------|-------------|------------|------|--------|------------|--------------|-----------------|------------------|-----------|-----------------|------|--------------|-----------|---------------------|-------|------
