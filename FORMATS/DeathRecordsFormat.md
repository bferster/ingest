...
**Example rows**
	...
	| line | full_name | first_name | middle_name | last_name | gender | birth_year | death_year | race | occupation | spouse_name | parent1 | parent2 | event_type | event_place | event_date |
	| ---- | --------- | ---------- | ----------- | --------- | ------ | ---------- | ---------- | ---- | ---------- | ----------- | ------- | ------- | ---------- | ----------- | ---------- |
...
**Translation instructions**
	...
	- Add the following field to the data JSONB field:
		...
		- event_place
		- event_date
		- i.e {"parent1": "John Arion", "parent2": "Betsy Garter", "spouse_name": "John Arion", "event_type": "Cancer", "event_place": "Augusta", "event_date": "October 1864"}
