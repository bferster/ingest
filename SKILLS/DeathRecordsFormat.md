	...
	- for each mention added after ingestion of this source {
		...
		- if parent1 != null then {
			...
			- create first new parent mention
				- set new parent mention_id with new mention_id with format: for example: ALB-DE-1.1, where  "ALB" is the county, "VR" is the prefix and "1.1" is the index for first parent.
			- Add mention to mentions table.
			}
		...
		- if parent1 != null then {
			...
			- create second new parent mention
				- set new parent mention_id with new mention_id with format: for example: ALB-DE-1.2, where  "ALB" is the county, "VR" is the prefix and "1.2" is the index for second parent.
			- Add mention to mentions table.
			}
		...
		- if spouse_name != null then {
			...
			- create spouse mention
				- set new spouse mention_id with new mention_id with format: for example: ALB-DE-1.3, where  "ALB" is the county, "VR" is the prefix and "1.3" is the index for spouse.
			- Add mention to mentions table.
			}
	...
	- for each mention added after ingestion of this source {
		...
		- if owner_name != null then {
			...
			- create owner mention
				- set new owner mention_id with new mention_id with format: for example: ALB-DE-1.4, where  "ALB" is the county, "VR" is the prefix and "1.4" is the index for owner.
			- Add mention to mentions table.
			}
